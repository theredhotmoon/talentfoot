...
<template>
  <!-- Mobile only — horizontal scroll strip, hidden on lg -->
  <div class="order-2 mt-3 lg:hidden">
      ...
      <div class="flex gap-3 overflow-x-auto pb-2" style="scrollbar-width: thin;">
        ...
        <div
          ...
          :class="[
            ...
            !activeSubclipId ? 'border-emerald-400 shadow-lg shadow-emerald-400/20' : 'border-transparent hover:border-white/20',
          ]"
        >
          <div class="relative w-44 h-24" style="background: rgba(255,255,255,0.04);">
        ...
        <div
          ...
          :class="[
            'flex-shrink-0 w-44 rounded-lg overflow-hidden cursor-pointer transition-all duration-200 border-2',
            activeSubclipId === subclip.id ? 'border-emerald-400 shadow-lg shadow-emerald-400/20' : 'border-transparent hover:border-white/20',
          ]"
        >
          <div class="relative w-44 h-24" style="background: rgba(255,255,255,0.04);">
