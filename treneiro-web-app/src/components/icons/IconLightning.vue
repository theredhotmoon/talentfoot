<template>
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M13 3L4 14H12L11 21L20 10H12L13 3Z" fill="url(#lightningGrad)" opacity="0.2"/>
    <defs>
      <linearGradient id="lightningGrad" x1="4" y1="3" x2="20" y2="21" gradientUnits="userSpaceOnUse">
